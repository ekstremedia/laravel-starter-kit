...
class WorkspaceController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $data = $request->validate([
            ...
            'slug' => ['nullable', 'string', 'max:63', 'regex:/^[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/', Rule::unique('workspaces', 'slug')],
        ]);
    ...
    public function edit(Workspace $workspace, StorageUsageService $usage): Response
    {
        ...
        return Inertia::render('Admin/Workspaces/Edit', [
            ...
            'assignableRoles' => WorkspaceMembership::assignableRoles(),
            'defaultRole' => in_array($appSettings->default_role, WorkspaceMembership::assignableRoles(), true)
